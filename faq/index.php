              ...
              <table class="table table-bordered table-hover">
                ...
                <tbody>
                  <?php foreach ($faqs as $faq) : ?>
                    <tr>
                      <td>
                        <a href="delete/?id=<?php echo h($faq['id']); ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                      </td>
                      <td><?php echo h($faq['id']); ?></td>
                      <td><?php echo h($faq['question']); ?></td>
                      <td><?php echo h($faq['answer']); ?></td>
                      <td><?php echo h($faq['created_person']); ?></td>
                      <td><?php echo h($faq['created']); ?></td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
              </table>
